      ...
      <main className="flex w-full flex-col items-center" id="maincontent">
        <div className="w-[45em] max-w-[93vw]">
          ...
          <p>
            ...
            SERVICE is provided by Filip Troníček at no cost and is intended for
            use as is.
          </p>{' '}
          <p>
          ...
          <p>
            ...
            our Terms and Conditions, which are accessible at Interclip unless
          ...
          <p>
            ...
            including but not limited to Display name. The information that I
          ...
          <p>This policy is effective as of 2022-03-13</p>{' '}
          <p>
            <H2>Contact Us</H2>
          </p>
          <p>
